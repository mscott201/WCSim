...
void WCSimDetectorConstruction::SetNuPrismGeometry(G4String PMTType, G4double PMTCoverage, G4double shaftHeight, G4double shaftDiameter, G4double detectorHeight, G4double detectorOffset, G4double detectorDiameter)
{
    ...
    WCShaftDiameter          = shaftDiameter;
    WCShaftHeight            = shaftHeight;
    WCIDHeight               = detectorHeight;
    WCIDOffset               = detectorOffset;
...
{
    SetNuPrismGeometry("PMT10inch", 40.0, 52.4941*m, 10*m, 52.48*m, 0*m, 6*m);
}
